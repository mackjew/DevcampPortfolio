class PortfoliosController < ApplicationController
    ...
    layout("portfolio")
    access( all: [:show, :index, :angular], user: {except: [:destroy, :new, :create, :update, :edit]}, site_admin: :all, message: "You do not have permissions to access this part of the site")
